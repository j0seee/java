	...
	public static void main(String[] args) {
		...
		String contenidoJenkinsfile = 
				"pipeline {\n" +
                        ...
                        "            steps {\n" +
                        "                script {\n" +
                        "                    echo 'La ciudad de " + Madrid.nombre + " tiene una población de " + Madrid.poblacion_final() + "'\n"+
                        "                }\n" +
                        "            }\n" +
                        "        }\n" +
                        "         stage('Malaga') {\n" +
                        ...
                        "            steps {\n" +
                        "                script {\n" +
                        "                    echo 'La ciudad de " + Sevilla.nombre + " tiene una población de " + Sevilla.poblacion_final() + "'\n"+
                        "                }\n" +
                        "            }\n" +
                        "        }\n" +
                        "    }\n" +
